...
let j1 = new Jugador("Claudia"),
    j2 = new Jugador("Fausto"),
    filas = 6, //suponiendo que el usuario haya elegido "4 en linea"
    cols = 7;
    
let juego = new Juego(j1, j2, img1, img2, imgBoard, filas, cols, canvasWidth, canvasHeight, ctx);
